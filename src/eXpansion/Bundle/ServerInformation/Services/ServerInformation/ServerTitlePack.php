...
class ServerTitlePack extends ServerName
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->serverInformationLineFactory->create("expansion_server_information.server_title_pack", $this->dataStorage->getTitle());
    }
}
