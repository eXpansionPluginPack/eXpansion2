...
abstract class Map implements ActiveRecordInterface
{
     ...
     * @return ObjectCollection|Maprating[] List of Maprating objects
     */
    public function getMapratingsJoinPlayer(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = MapratingQuery::create(null, $criteria);
