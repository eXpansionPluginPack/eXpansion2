...
class MxmapTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('trackUID', 'Trackuid', 'VARCHAR', 'map', 'mapUid', true, 255, null);
        $this->addColumn('gbxMapName', 'Gbxmapname', 'VARCHAR', false, 255, null);
        ...
        $this->addColumn('titlePack', 'Titlepack', 'VARCHAR', false, 255, null);
        $this->addColumn('styleName', 'Stylename', 'VARCHAR', false, 255, null);
        $this->addColumn('displayCost', 'Displaycost', 'INTEGER', false, null, null);
        $this->addColumn('modName', 'Modname', 'VARCHAR', false, 255, null);
        $this->addColumn('lightMap', 'Lightmap', 'INTEGER', false, null, null);
        $this->addColumn('exeVersion', 'Exeversion', 'VARCHAR', false, 50, null);
        $this->addColumn('exeBuild', 'Exebuild', 'VARCHAR', false, 50, null);
        $this->addColumn('environmentName', 'Environmentname', 'VARCHAR', false, 255, null);
        $this->addColumn('vehicleName', 'Vehiclename', 'VARCHAR', false, 255, null);
        $this->addColumn('unlimiterRequired', 'Unlimiterrequired', 'BOOLEAN', false, 1, null);
        $this->addColumn('routeName', 'Routename', 'VARCHAR', false, 255, null);
        $this->addColumn('lengthName', 'Lengthname', 'VARCHAR', false, 100, null);
        $this->addColumn('laps', 'Laps', 'INTEGER', false, null, null);
        $this->addColumn('difficultyName', 'Difficultyname', 'VARCHAR', false, 255, null);
        $this->addColumn('replayTypeName', 'Replaytypename', 'VARCHAR', false, 255, null);
        ...
        $this->addColumn('replayWRUsername', 'Replaywrusername', 'VARCHAR', false, 255, null);
