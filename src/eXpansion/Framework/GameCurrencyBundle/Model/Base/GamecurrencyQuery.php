...
use eXpansion\Framework\GameCurrencyBundle\Model\Gamecurrency as ChildGamecurrency;
...
abstract class GamecurrencyQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \eXpansion\Framework\GameCurrencyBundle\Model\Base\GamecurrencyQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'expansion', $modelName = '\\eXpansion\\Framework\\GameCurrencyBundle\\Model\\Gamecurrency', $modelAlias = null)
    {
