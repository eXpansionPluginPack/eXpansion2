...
use eXpansion\Core\DataProviders\MatchDataProvider;
 ...
 *
 * @package Tests\eXpansion\Core\DataProviders
...
class MatchDataProviderTest extends TestCore
{
    ...
    protected function setUp()
    {
        ...
        $this->container->set('expansion.core.storage.player', $this->playerStorageMock);

        $this->pluginMock = $this->createMock(MatchDataListenerInterface::class);
        $this->matchDataProvider = $this->container->get('expansion.core.data_providers.match_data_provider');
